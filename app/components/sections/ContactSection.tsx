...
const contactLinks = [
    ...
    { icon: FaLinkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/your-username/' },
    { icon: FaGithub, label: 'GitHub', href: 'https://github.com/your-username' },
    { icon: FaYoutube, label: 'YouTube', href: 'https://www.youtube.com/@your-channel' },
    { icon: FaTwitter, label: 'Twitter', href: 'https://twitter.com/your-handle' },
    { icon: FaLastfm, label: 'Last.fm', href: 'https://www.last.fm/user/your-username' },
];
                    ...
                    <motion.div className="space-y-10" variants={itemVariants}>
                        ...
                        <div>
                            ...
                            <div className="group border border-gray-200 p-4 transition-all duration-300 hover:border-gray-800 bg-[linear-gradient(theme(colors.gray.100)_1px,transparent_1px),linear-gradient(to_right,theme(colors.gray.100)_1px,transparent_1px)] bg-[size:20px_20px] hover:bg-[size:22px_22px]"> {/* CHANGED */}
                                <p className="font-mono text-sm text-black">[YOUR CITY], [YOUR COUNTRY]</p> {/* CHANGED */}
                                <p className="font-mono text-xs text-gray-500 mt-1">TIMEZONE: [GMT+X] // STATUS: OPERATIONAL</p> {/* CHANGED */}
                            </div>
                        </div>
                    </motion.div>
                </div>
