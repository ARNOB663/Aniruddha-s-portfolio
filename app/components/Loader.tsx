...
const Loader = ({ onLoaded }: { onLoaded: () => void }) => {
  ...
  return (
    <motion.div
      ...
      className={`fixed inset-0 bg-black z-[100] flex items-center justify-center ${progress >= 100 ? 'pointer-events-none' : ''
        }`}
    >
      ...
      <div className="absolute bottom-6 left-6 font-mono text-xs text-neutral-500">[ANIRUDDHA.DEV.NATH]</div>
