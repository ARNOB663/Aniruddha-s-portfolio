...
const socialLinks = [
    { name: 'Email', icon: FiMail, href: 'mailto:your.email@example.com' },
    { name: 'LinkedIn', icon: FaLinkedin, href: 'https://www.linkedin.com/in/your-username/' },
    { name: 'GitHub', icon: FaGithub, href: 'https://github.com/your-username' },
    { name: 'YouTube', icon: FaYoutube, href: 'https://www.youtube.com/@your-channel' },
    { name: 'Twitter', icon: FaTwitter, href: 'https://twitter.com/your-handle' },
    { name: 'Last.fm', icon: FaLastfm, href: 'https://www.last.fm/user/your-username' },
    { name: 'Anilist', icon: SiAnilist, href: 'https://anilist.co/user/your-username/' },
];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-8">
                    ...
                    <p className="font-mono text-xs text-neutral-500"> {/* CHANGED */}
                        © {new Date().getFullYear()} ANIRUDDHA.DEV
                    </p>
